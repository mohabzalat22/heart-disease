      ...
      <div className="hidden lg:flex flex-col justify-between bg-zinc-900 p-10 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &quot;This platform has completely transformed how we assess cardiovascular risks, providing precise and timely insights that save lives.&quot;
            </p>
            <footer className="text-sm text-zinc-400">Dr. Sarah Jenkins, Chief Cardiologist</footer>
          </blockquote>
        </div>
      </div>
